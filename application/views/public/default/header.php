			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xl-2 col-lg-3 col-md-3">
						<div class="logo-area">
							<a href=<?= base_url('/welcome') ?>><img src=<?= base_url("/assets/img/logo.png") ?> alt="enventer"></a>
						</div>
					</div>
					<!-- mainmenu-area-->
					<div class="col-xl-10 col-lg-9 col-md-9">
						<div class="main-menu f-right">
							<nav id="mobile-menu">
								<ul>
									<li>
										<a class="current" href=<?= base_url('/welcome') ?>>home</a>
									</li>
									<li>
										...
										<div class="contact-form-area login">
											...
											<div class="contact-form login">
												<form action="#">
													...
													<div class="login-btn">
														<input type="submit" value="log in" id="formsend">
													</div>
												</form>
											</div>
											<!--contact right bg-->
